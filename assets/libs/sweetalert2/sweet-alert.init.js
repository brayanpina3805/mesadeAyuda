    ...
    SweetAlert.prototype.init = function () {
        ...
        $("#sa-passparameter").click(function () {
            ...
            swalWithBootstrapButtons.fire({
                title: 'Se a enviado la solicitad a tu compañero',
                text: "Espera en lo que tu compa te da chance",
                type: 'warning',
                showCancelButton: true,
                confirmButtonText: 'si espero',
                ...
                if (result.value) {
                    ...
                    swalWithBootstrapButtons.fire(
                        'Rechazado',
                        'Comunicate con tu compañero y vuelve a intentarlo',
                        'error'
                    )
                }
            })
